...
f.push(x);break}}}}return f},n.region=function(e,t,o){for(var n=[],i=0;i<e.length;i++){var r=e[i],a=s.overlaps(r.bounds,t);(a&&!o||!a&&o)&&n.push(r)}return n},n.point=function(e,t){for(var o=[],n=0;n<e.length;n++){var i=e[n];if(s.contains(i.bounds,t))for(var r=1===i.parts.length?0:1;r<i.parts.length;r++){var a=i.parts[r];if(s.contains(a.bounds,t)&&l.contains(a.vertices,t)){o.push(i);break}}}return o}}()},{"../factory/Bodies":21,"../geometry/Bounds":24,"../geometry/Vector":26,"../geometry/Vertices":27,"./SAT":11}],10:[function(e,t,o){var n={};t.exports=n;var i=e("../body/Body"),r=e("../geometry/Vertices"),s=e("../geometry/Vector"),a=e("../core/Common"),l=e("../geometry/Bounds"),c=e("../collision/SAT");!function(){n._restingThresh=4,n._restingThreshTangent=6,n._positionDampen=.9,n._positionWarming=.8,n._frictionNormalMultiplier=5,n.solveContinuous=function(e){var t,o,n,r;for(t=0;t<e.length;t++)if(o=e[t],!(o.depth>=0)){n=o.bodyA.parent,r=o.bodyB.parent;var a=Math.abs(s.dot(o.normal,n.velocity)),l=Math.abs(s.dot(o.normal,r.velocity)),d=a+l,u=a/d,p=l/d;
u>0&&i.translate(n,{x:o.penetration.x*u,y:o.penetration.y*u}),p>0&&i.translate(r,{x:-o.penetration.x*p,y:-o.penetration.y*p}),o.depth=0,o.penetration.x=0,o.penetration.y=0,o.supports=c.findSupports(o)}},n.preSolvePosition=function(e){var t,o,n;for(t=0;t<e.length;t++)o=e[t],o.isActive&&(n=o.activeContacts.length,o.collision.parentA.totalContacts+=n,o.collision.parentB.totalContacts+=n)},n.solvePosition=function(e,t){var o,i,r,a,l,c,d,u,p,f=s._temp[0],v=s._temp[1],m=s._temp[2],y=s._temp[3];for(o=0;o<e.length;o++)i=e[o],i.isActive&&!i.isSensor&&(r=i.collision,a=r.parentA,l=r.parentB,c=r.normal,d=s.sub(s.add(l.positionImpulse,l.position,f),s.add(a.positionImpulse,s.sub(l.position,r.penetration,v),m),y),i.separation=s.dot(c,d));for(o=0;o<e.length;o++)i=e[o],!i.isActive||i.isSensor||i.separation<0||(r=i.collision,a=r.parentA,l=r.parentB,c=r.normal,p=(i.separation-i.slop)*t,(a.isStatic||l.isStatic)&&(p*=2),a.isStatic||a.isSleeping||(u=n._positionDampen/a.totalContacts,a.positionImpulse.x+=c.x*p*u,
a.positionImpulse.y+=c.y*p*u),l.isStatic||l.isSleeping||(u=n._positionDampen/l.totalContacts,l.positionImpulse.x-=c.x*p*u,l.positionImpulse.y-=c.y*p*u))},n.postSolvePosition=function(e){for(var t=0;t<e.length;t++){var o=e[t];if(o.totalContacts=0,0!==o.positionImpulse.x||0!==o.positionImpulse.y){for(var i=0;i<o.parts.length;i++){var a=o.parts[i];r.translate(a.vertices,o.positionImpulse),l.update(a.bounds,a.vertices,o.velocity),a.position.x+=o.positionImpulse.x,a.position.y+=o.positionImpulse.y}o.positionPrev.x+=o.positionImpulse.x,o.positionPrev.y+=o.positionImpulse.y,s.dot(o.positionImpulse,o.velocity)<0?(o.positionImpulse.x=0,o.positionImpulse.y=0):(o.positionImpulse.x*=n._positionWarming,o.positionImpulse.y*=n._positionWarming)}}},n.preSolveVelocity=function(e){var t,o,n,i,r,a,l,c,d,u,p,f,v,m,y=s._temp[0],g=s._temp[1];for(t=0;t<e.length;t++)if(n=e[t],n.isActive&&!n.isSensor)for(i=n.activeContacts,r=n.collision,a=r.parentA,l=r.parentB,c=r.normal,d=r.tangent,o=0;o<i.length;o++)u=i[o],p=u.vertex,
f=u.normalImpulse,v=u.tangentImpulse,0===f&&0===v||(y.x=c.x*f+d.x*v,y.y=c.y*f+d.y*v,a.isStatic||a.isSleeping||(m=s.sub(p,a.position,g),a.positionPrev.x+=y.x*a.inverseMass,a.positionPrev.y+=y.y*a.inverseMass,a.anglePrev+=s.cross(m,y)*a.inverseInertia),l.isStatic||l.isSleeping||(m=s.sub(p,l.position,g),l.positionPrev.x-=y.x*l.inverseMass,l.positionPrev.y-=y.y*l.inverseMass,l.anglePrev-=s.cross(m,y)*l.inverseInertia))},n.solveVelocity=function(e,t){for(var o=t*t,i=s._temp[0],r=s._temp[1],l=s._temp[2],c=s._temp[3],d=s._temp[4],u=s._temp[5],p=0;p<e.length;p++){var f=e[p];if(f.isActive&&!f.isSensor){var v=f.collision,m=v.parentA,y=v.parentB,g=v.normal,x=v.tangent,h=f.activeContacts,b=1/h.length;m.velocity.x=m.position.x-m.positionPrev.x,m.velocity.y=m.position.y-m.positionPrev.y,y.velocity.x=y.position.x-y.positionPrev.x,y.velocity.y=y.position.y-y.positionPrev.y,m.angularVelocity=m.angle-m.anglePrev,y.angularVelocity=y.angle-y.anglePrev;for(var w=0;w<h.length;w++){var S=h[w],C=S.vertex,A=s.sub(C,m.position,r),B=s.sub(C,y.position,l),M=s.add(m.velocity,s.mult(s.perp(A),m.angularVelocity),c),P=s.add(y.velocity,s.mult(s.perp(B),y.angularVelocity),d),k=s.sub(M,P,u),I=s.dot(g,k),T=s.dot(x,k),V=Math.abs(T),R=a.sign(T),E=(1+f.restitution)*I,_=a.clamp(f.separation+I,0,1)*n._frictionNormalMultiplier,F=T,O=1/0;
V>f.friction*f.frictionStatic*_*o&&(O=V,F=a.clamp(f.friction*R*o,-O,O));var L=s.cross(A,g),q=s.cross(B,g),W=b/(m.inverseMass+y.inverseMass+m.inverseInertia*L*L+y.inverseInertia*q*q);if(E*=W,F*=W,0>I&&I*I>n._restingThresh*o)S.normalImpulse=0;else{var D=S.normalImpulse;S.normalImpulse=Math.min(S.normalImpulse+E,0),E=S.normalImpulse-D}if(T*T>n._restingThreshTangent*o)S.tangentImpulse=0;else{var N=S.tangentImpulse;S.tangentImpulse=a.clamp(S.tangentImpulse+F,-O,O),F=S.tangentImpulse-N}i.x=g.x*E+x.x*F,i.y=g.y*E+x.y*F,m.isStatic||m.isSleeping||(m.positionPrev.x+=i.x*m.inverseMass,m.positionPrev.y+=i.y*m.inverseMass,m.anglePrev+=s.cross(A,i)*m.inverseInertia),y.isStatic||y.isSleeping||(y.positionPrev.x-=i.x*y.inverseMass,y.positionPrev.y-=i.y*y.inverseMass,y.anglePrev-=s.cross(B,i)*y.inverseInertia)}}}}}()},{"../body/Body":1,"../collision/SAT":11,"../core/Common":14,"../geometry/Bounds":24,"../geometry/Vector":26,"../geometry/Vertices":27}],11:[function(e,t,o){var n={};t.exports=n;var i=e("../geometry/Vertices"),r=e("../geometry/Vector");
!function(){n.collides=function(t,o,i){var s,a,l,c,d,u,p,f,v=i,m=!1;if(t.continuous||o.continuous)if(d=r.sub(t.parent.position,t.parent.positionPrev),u=r.sub(o.parent.position,o.parent.positionPrev),p=r.sub(d,u),2===t.continuous||2===o.continuous)f=p;else{var y=Math.min(t.bounds.max.x-t.bounds.min.x-Math.abs(d.x),o.bounds.max.x-o.bounds.min.x-Math.abs(u.x)),g=Math.min(t.bounds.max.y-t.bounds.min.y-Math.abs(d.y),o.bounds.max.y-o.bounds.min.y-Math.abs(u.y));(Math.abs(p.x)>y||Math.abs(p.y)>g)&&(f=p)}if(v){var x=t.parent,h=o.parent,b=x.speed*x.speed+x.angularSpeed*x.angularSpeed+h.speed*h.speed+h.angularSpeed*h.angularSpeed;m=v&&v.collided&&.2>b,c=v}else c={collided:!1,bodyA:t,bodyB:o};if(v&&m){var w=c.axisBody,S=w===t?o:t,C=[w.axes[v.axisNumber]];if(l=e(w.vertices,S.vertices,C,f),c.reused=!0,null===l.overlap)return c.collided=!1,c}else{if(s=e(t.vertices,o.vertices,t.axes,f),null===s.overlap)return c.collided=!1,c;if(a=e(o.vertices,t.vertices,o.axes,f),null===a.overlap)return c.collided=!1,
c;Math.abs(s.overlap)<Math.abs(a.overlap)?(l=s,c.axisBody=t):(l=a,c.axisBody=o),c.axisNumber=l.axisNumber}return c.bodyA=t.id<o.id?t:o,c.bodyB=t.id<o.id?o:t,c.collided=!0,c.normal=l.axis,c.depth=l.overlap,c.parentA=c.bodyA.parent,c.parentB=c.bodyB.parent,t=c.bodyA,o=c.bodyB,r.dot(c.normal,r.sub(o.position,t.position))>0&&(c.normal=r.neg(c.normal)),c.tangent=r.perp(c.normal),c.penetration={x:c.normal.x*c.depth,y:c.normal.y*c.depth},c.supports=n.findSupports(c),c},n.findSupports=function(e){var t=e.bodyA,n=e.bodyB,s=o(t,n,e.normal),a=e.supports||[];if(a.length=0,i.contains(t.vertices,s[0])&&a.push(s[0]),i.contains(t.vertices,s[1])&&a.push(s[1]),a.length<2){var l=o(n,t,r.neg(e.normal));i.contains(n.vertices,l[0])&&a.push(l[0]),a.length<2&&i.contains(n.vertices,l[1])&&a.push(l[1])}return a.length<1&&(a=[s[0]]),a};var e=function(e,o,n,i){var s,a,l,c=r._temp[0],d=r._temp[1],u={overlap:Number.MAX_VALUE};for(l=0;l<n.length;l++){if(a=n[l],t(c,e,a),t(d,o,a),s=Math.min(c.max-d.min,d.max-c.min),0>=s){
if(!i)return u.overlap=null,u;var p=r.dot(a,i);if(-s>p&&p>s)return u.overlap=null,u}s<u.overlap&&(u.overlap=s,u.axis=a,u.axisNumber=l)}return u},t=function(e,t,o){for(var n=r.dot(t[0],o),i=n,s=1;s<t.length;s+=1){var a=r.dot(t[s],o);a>i?i=a:n>a&&(n=a)}e.min=n,e.max=i},o=function(e,t,o){for(var n,i,s,a,l=Number.MAX_VALUE,c=r._temp[0],d=t.vertices,u=e.position,p=0;p<d.length;p++)i=d[p],c.x=i.x-u.x,c.y=i.y-u.y,n=-r.dot(o,c),l>n&&(l=n,s=i);var f=s.index-1>=0?s.index-1:d.length-1;i=d[f],c.x=i.x-u.x,c.y=i.y-u.y,l=-r.dot(o,c),a=i;var v=(s.index+1)%d.length;return i=d[v],c.x=i.x-u.x,c.y=i.y-u.y,n=-r.dot(o,c),l>n&&(a=i),[s,a]}}()},{"../geometry/Vector":26,"../geometry/Vertices":27}],12:[function(e,t,o){var n={};t.exports=n;var i=e("../geometry/Vertices"),r=e("../geometry/Vector"),s=e("../core/Sleeping"),a=e("../geometry/Bounds"),l=e("../geometry/Axes"),c=e("../core/Common");!function(){var e=1e-6,t=.001;n.create=function(t){var o=t;o.bodyA&&!o.pointA&&(o.pointA={x:0,y:0}),o.bodyB&&!o.pointB&&(o.pointB={
...
timestamp:o.timing.timestamp};if(a.trigger(e,"beforeRender",h),e.currentBackground!==y&&p(e,y),u.globalCompositeOperation="source-in",u.fillStyle="transparent",u.fillRect(0,0,d.width,d.height),u.globalCompositeOperation="source-over",f.hasBounds){var b=e.bounds.max.x-e.bounds.min.x,w=e.bounds.max.y-e.bounds.min.y,S=b/f.width,C=w/f.height;for(t=0;t<v.length;t++){var A=v[t];s.overlaps(A.bounds,e.bounds)&&g.push(A)}for(t=0;t<m.length;t++){var B=m[t],M=B.bodyA,P=B.bodyB,k=B.pointA,I=B.pointB;M&&(k=c.add(M.position,B.pointA)),P&&(I=c.add(P.position,B.pointB)),k&&I&&(s.contains(e.bounds,k)||s.contains(e.bounds,I))&&x.push(B)}u.scale(1/S,1/C),u.translate(-e.bounds.min.x,-e.bounds.min.y)}else x=m,g=v;!f.wireframes||o.enableSleeping&&f.showSleeping?n.bodies(e,g,u):(f.showConvexHulls&&n.bodyConvexHulls(e,g,u),n.bodyWireframes(e,g,u)),f.showBounds&&n.bodyBounds(e,g,u),(f.showAxes||f.showAngleIndicator)&&n.bodyAxes(e,g,u),f.showPositions&&n.bodyPositions(e,g,u),f.showVelocity&&n.bodyVelocity(e,g,u),
